...
Telegram::Bot::Client.run(token) do |bot|
  ...
  when '/start'
    ...
    answers =
      ...
      .new(keyboard: [ ["/start", "/stop"], "/start", "/stop", "/start", "/stop"], one_time_keyboard: true)
    ...
    bot.api.send_message(chat_id: message.chat.id, text: 'Sorry to see you go :(', reply_markup: kb)
	  ...
	  #case message.text
			...
			if impTovUslug['name'] == params[0]
				...
				deb << "some problems with this data. I DONT UNDERSTAND YOU, BABY"
   	...
   	#	answers =	Telegram::Bot::Types::ReplyKeyboardMarkup.new(keyboard: [A,B,C,D], one_time_keyboard: true)
